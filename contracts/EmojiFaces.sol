    ...
    contract EmojiFaces is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public constant tokenPrice = 200000000000000000; // 0.2 ETH 
      ...
      constructor() ERC721("NONFUSHANCHAN", "NFSC") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmV3xqKsXDwS7JeG7vRQVo1Vk18jcWJM5h1ejSDmAYr8r5";
        }
    
        return
          bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, tokenId.toString(), ".json"))
            : "ipfs://QmYUZsPNoJa2Ua3uAYEBziTK8TkFmSKK7vy8JudUwoeg2U";
